...
if(!['786688330879598643'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
return message.reply(`Bu Komut İçin Yetkiniz Bulunmamaktadır.`) 
  
const kadın = message.guild.roles.cache.find(r => r.id === '786690699546066954')
const kadın2 = message.guild.roles.cache.find(r => r.id === '786689232936501279')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '786689371990261792')
const savelogs = message.guild.channels.cache.find(c => c.id === '789564246476193863')
